    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/", new HttpHandler() {
            public void handle(HttpExchange res) throws IOException {
                serveFile(res, "/Users/sebastianriano/data-analysis-b/index.html", "text/html");
            }
        });

        server.createContext("/style.css", new HttpHandler() {
            public void handle(HttpExchange res) throws IOException {
                serveFile(res, "/Users/sebastianriano/data-analysis-b/style.css", "text/css");
            }
        });

        server.createContext("/code.js", new HttpHandler() {
            public void handle(HttpExchange res) throws IOException {
                serveFile(res, "/Users/sebastianriano/data-analysis-b/code.js", "application/javascript");
            }
        });
